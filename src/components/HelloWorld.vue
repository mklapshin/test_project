<template>
  <div class="main">
    ...
    <div class="howtouse">
      <div class="senMain">vue-drag-tree</div>
    </div>
    <div class="container">
      <div class="treeSelf">
        <VueDragTree
    ...
    <div class="sentence">
      <a href="https://github.com/shuiRong/vue-drag-tree" target="_blanket"
        >View Documentation</a
      >
    </div>
    <iframe
      src="https://ghbtns.com/github-btn.html?user=shuiRong&repo=vue-drag-tree&type=star&count=true&size=large"
      frameborder="0"
      scrolling="0"
      width="160px"
      height="30px"
